    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_site', models.ForeignKey(default=10, editable=False, to='sites.Site', on_delete=models.CASCADE)),
            ],
            options={
                'ordering': ('name',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(related_name='translations', editable=False, to='fluentcms_emailtemplates.EmailTemplate', on_delete=models.CASCADE, null=True)),
            ],
            options={
                'managed': True,
