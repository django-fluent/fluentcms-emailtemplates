...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmailTextItem'
        db.create_table(u'contentitem_emailtext_emailtextitem', (
            ...
            ('html', self.gf('fluent_contents.extensions.PluginHtmlField')()),
            ('text', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'emailtext', ['EmailTextItem'])


    def backwards(self, orm):
        # Deleting model 'EmailTextItem'
        db.delete_table(u'contentitem_emailtext_emailtextitem')
    ...
    models = {
        ...
        u'emailtext.emailtextitem': {
            'Meta': {'object_name': 'EmailTextItem', 'db_table': "u'contentitem_emailtext_emailtextitem'"},
            ...
            'html': ('fluent_contents.extensions.PluginHtmlField', [], {}),
